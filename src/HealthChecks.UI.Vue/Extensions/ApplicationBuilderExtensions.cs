...
using HealthChecks.UI.Vue.Middleware;

namespace Microsoft.AspNetCore.Builder;

public static class ApplicationBuilderExtensions
{
    public static IApplicationBuilder UseHealthChecksVueUI(this IApplicationBuilder app, Action<Options> setup)
    {
    ...
    public static IApplicationBuilder UseHealthChecksVueUI(this IApplicationBuilder app)
    {
